...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <div id="page-wrap">
            ...
            <div id="content-wrap">
                <div id="content">
                    <h1 class="right_guess">You ran out of guesses!</h1>
                    <h1>Wazza was in <?php echo $_GET['suburb'] ?>.</h1>
                    <h1>You scored 0 points...</h1>
                    <img src="images/winner.gif" />
                </div>
                <div id="sidebar">
                    <img id="guess_map" src="http://maps.google.com/maps/api/staticmap?center=<?php echo $_GET['pcode'] ?>,VIC&zoom=6&size=400x400&sensor=false" />
                </div>
